	 ...
	 public static Object handleMessage (Request request, Connection connection) {
			...
			try {
				...
				ResultSet res = stmnt.executeQuery("SELECT ghealth.reference.refID,ghealth.reference.refDate"
						...
						+ "FROM ghealth.reference,ghealth.clients,ghealth.specialists,ghealth.examinationtype WHERE reference.client_id = '"+reference.getClientId()+"' && reference.specialist_id = '"+reference.getSpecialistId()+"' && reference.refDate ='"+sqlDate+"'"
			    ...
			    if (res.next()) {
			    	//get details from the reference table
			    		reference1.setClientId(res.getInt(7));  
			    		reference1.setSpecialistId(res.getInt(8));  
			    		...
			    		if(res.getString(6) == null)    
						   	...
						   	reference1.setReferenceNumber(res.getInt(1)); 
